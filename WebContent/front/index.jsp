  ...
  <body data-spy="scroll" data-target=".navbar-example">
    ...
    <div class="main-body-wrapper">
        ...
        <div class="main-body-left navbar-example">
            <ul>
                <li><a class="jy" href="#jy">就业</a></li>
                <li><a class="jk" href="#jk">健康</a></li>
                <li><a class="mr" href="#mr">美容</a></li>
                <li><a class="qg" href="#qg">情感</a></li>
                <li><a class="jyu" href="#jyu">教育</a></li>
                <li><a class="ly" href="#ly">旅游</a></li>
                <li><a class="yy" href="#yy">音乐</a></li>
                <li><a class="zt" href="#zt">杂谈</a></li>
                <li><a class="bd" href="#bd">本地</a></li>
            </ul>
        </div>
        ...
        <div class="main-body-middle">
            ...
            <div class="middle-detail" id="mr">
                <p class="title">美容<span><a href="<%=request.getContextPath()%>/showlist.do?firstDirectory=3">更多</a></span></p>
                <ul>
            ...
            <div class="middle-detail" id="jyu">
